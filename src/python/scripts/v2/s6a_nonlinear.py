...
intrim_fiducial_folder = sys.argv[5]
op_imgs_folder = sys.argv[6]
op_allen_coords_folder = sys.argv[7]
...
for nissl_id in nissl_ids:
    ...
    intrim_pts_file = chuck_space_coords_folder+"/chuck_sp_img_coords_"+nis_idx+".csv"
    ...
    temp_output_csv_file = op_allen_coords_folder+"/chuck_sp_img_coords_"+nis_idx+".csv"
