// Reads in 3 csv files, outputs 1 csv and 1 image
// Inputs - From fiducial positions csv, 
//          to fiducial positions csv, 
//          positions to be transformed csv,
// Output - a list of label positions stored in a csv 
//        - a scatterplot image of those positions

// Usage example: make -j4 && ./drawer ../input/F.csv ../input/T.csv ../input/points_list.csv output.csv output.png
